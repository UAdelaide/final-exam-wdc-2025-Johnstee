...
(async () => {
    ...
    `);
        ...
        await db.execute(`insert into WalkRatings(request_id,walker_id,owner_id,rating,comments) values((select dog_id from Dogs where name = 'Pinky'),'2025-06-15 01:30:00',15,'Dogpark','accepted')`);
